...
class Odoo(ComponentResource):
    ...
    def __init__(self,
        ...
        self.task_definition = Output.all(db.host, db.port, db.name, db.user, db.pssw).apply(
            lambda args:
        ...
        self.web_url=pulumi.Output.concat('http://', self.alb.dns_name)
